...
def create_data_for_database_entry(tourney_name, event_name):
	...
	update_players_with_sgg_player_id(players, entrant_id_to_sgg_player_id_map)
...
def update_sets_with_sgg_ids(sets_from_api, entrant_id_to_sgg_player_id_map, tournament):
	...
	return sets_from_api

#Update players with sgg player ids
def update_players_with_sgg_player_id(players_from_api, entrant_id_to_sgg_player_id_map):
...
def create_tournament_entity(tournament_from_api):
	...
	tournament["date"] = tournament_from_api["start_at"]
